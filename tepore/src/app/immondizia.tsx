...
const styles = StyleSheet.create({
  ...
  onboardingTitle: { fontSize: 17, fontFamily: fonts.bold, fontWeight: "700", color: "#2F4858", marginBottom: 8, textAlign: "center" },
  onboardingText: { fontSize: 13, color: "#6C7A85", textAlign: "center", lineHeight: 19, marginBottom: 20 },
  onboardingButton: { backgroundColor: "#336699", borderRadius: 12, paddingVertical: 14, paddingHorizontal: 24 },
  onboardingButtonText: { color: "#fff", fontSize: 14, fontFamily: fonts.semibold, fontWeight: "600" },
  ...
  oggiLabel: { fontSize: 13, color: "#6C7A85", marginBottom: 8 },
  ...
  oggiBadgeText: { fontSize: 18, fontFamily: fonts.bold, fontWeight: "700" },
  oggiLettere: { fontSize: 30, fontFamily: fonts.bold, fontWeight: "700", color: "#2F4858" },
  oggiNomi: { fontSize: 12, color: "#6C7A85", marginTop: 4, textAlign: "center" },
  oggiValueVuoto: { fontSize: 16, color: "#6C7A85", fontStyle: "italic" },
  avvisoAnnoCard: {
  ...
  avvisoAnnoText: { fontSize: 13, color: "#6C7A85", lineHeight: 18 },
  sectionTitle: { fontSize: 16, fontFamily: fonts.semibold, fontWeight: "600", color: "#2F4858", marginBottom: 4 },
  sectionSubtitle: { fontSize: 12, color: "#6C7A85", marginBottom: 12, lineHeight: 17 },
  sectionTitleRow: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  mensileButton: { backgroundColor: "#336699", borderRadius: 8, paddingHorizontal: 10, paddingVertical: 5 },
  mensileButtonText: { color: "#fff", fontSize: 12, fontFamily: fonts.semibold, fontWeight: "600" },
  weekCard: {
    backgroundColor: "#fff",
    borderRadius: 14,
    borderWidth: 1,
  ...
  dayRowBorder: { borderBottomWidth: 1, borderBottomColor: "#EEF2F5" },
  dayRowOggi: { backgroundColor: "#DCEBF3" },
  ...
  dayValue: { fontSize: 14, fontFamily: fonts.bold, fontWeight: "700", color: "#2F4858" },
  dayValueVuoto: { fontSize: 14, color: "#C2CCD3" },
  emptyText: { textAlign: "center", color: "#6C7A85", fontSize: 14, marginTop: 8 },
  straordinariaCard: {
    backgroundColor: "#fff",
    borderRadius: 14,
    padding: 14,
  ...
  straordinariaNome: { fontSize: 14, fontFamily: fonts.semibold, fontWeight: "600", color: "#2F4858" },
  straordinariaData: { fontSize: 12, color: "#6C7A85", marginTop: 2 },
  straordinariaElimina: { fontSize: 12, color: "#D96A5B", fontFamily: fonts.semibold, fontWeight: "600" },
  fab: {
    position: "absolute",
    bottom: 30,
    right: 24,
